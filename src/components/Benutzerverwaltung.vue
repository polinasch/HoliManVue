  ...
  <b-container>
    ...
    <b-row>
      <b-col>
        <router-link to="/benutzer">
          <b-button type="button" block variant="secondary" class="btn"
            >Neuen Benutzer erstellen</b-button
          >
        </router-link>
      </b-col>
      <b-col>
        <router-link to="/home">
          <b-button type="cancel" block variant="light">Zur Startseite</b-button>
        </router-link>
      </b-col>
    </b-row>
    <b-table
    ...
    >
      ...
      <template #cell(Aktionen)="row">
        <router-link
          :to="{ name: 'editBenutzer', params: { id: row.item.BenutzerID } }"
        >
          <b-button
            size="sm"
            variant="primary"
        ...
        <b-button
          size="sm"
          @click="deleteBenutzer(row.item.BenutzerID)"
          variant="danger"
        >
